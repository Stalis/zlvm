...
function (pvs_studio_add_target)
    ...
    if (WIN32)
        ...
        string(REPLACE \\ cmake ROOT "${ROOT}")
    ...
    if (NOT "${PVS_STUDIO_LICENSE}" STREQUAL "")
        pvs_studio_join_path(PVS_STUDIO_LICENSE "." "${PVS_STUDIO_LICENSE}")
    ...
    if (PVS_STUDIO_PLOGS OR PVS_STUDIO_COMPILE_COMMANDS)
        if (WIN32)
            string(REPLACE cmake \\ PVS_STUDIO_PLOGS "${PVS_STUDIO_PLOGS}")
        endif ()
        if (WIN32)
    ...
    if (WIN32)
        string(REPLACE cmake \\ PVS_STUDIO_LOG "${PVS_STUDIO_LOG}")
    endif ()
